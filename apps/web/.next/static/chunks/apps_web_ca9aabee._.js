...
async function fetchShareholderBalance(companyId, address) {
    const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_BACKEND_URL || "http://localhost:3000"}/shareholders/${companyId}`);
    if (!res.ok) return 0;
            ...
            if (selectedCompany && address) {
                ({
                    "TradeView.useEffect": async ()=>{
                        try {
                            const balance = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShareholderBalance"])(selectedCompany.id, address);
            ...
            function mapCompany(raw) {
                if (Array.isArray(raw) && raw.length >= 5 && typeof raw[0] === "bigint" && typeof raw[1] === "string" && typeof raw[2] === "string" && typeof raw[3] === "bigint" && typeof raw[4] === "bigint") {
                    return {
                        ...
                        name: raw[1],
                        owner: raw[2],
                        totalSupply: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUnits"])(raw[4], 0),
                        currentPrice: priceData ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUnits"])(priceData, 18) : undefined
                    };
                }
                return null;
            }
...
_s(CompanyList, "5rAf3kN8szn9nR5Mhg3/MDAOPmo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$hooks$2f$useAccount$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAccount"],
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$hooks$2f$useDeStock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeStock"],
...
function TradingChart({ symbol = "DEMO", data = EMPTY_DATA, height = 400, showTimeframes = true, showIndicators = true, className = "" }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TradingChart.useEffect": ()=>{
            ...
            const chart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$lightweight$2d$charts$2f$dist$2f$lightweight$2d$charts$2e$development$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createChart"])(chartContainerRef.current, {
                width: chartContainerRef.current.clientWidth,
                height,
                layout: {
                    background: {
                        type: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$lightweight$2d$charts$2f$dist$2f$lightweight$2d$charts$2e$development$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ColorType"].Solid,
                        color: "transparent"
                    },
...
_s(TradingChart, "7jKwnUGqfize4b3psR3kb9NcK/0=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_ca9aabee._.js.map