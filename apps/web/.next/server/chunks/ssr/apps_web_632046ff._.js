...
function TradeView() {
        ...
        if (selectedCompany && address && publicClient) {
            (async ()=>{
                try {
                    ...
                    setUserShares(shareResult ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatUnits"])(shareResult, 0) : "0");
                } catch (error) {
                    setUserShares("0");
                }
            })();
    ...
    const onSubmit = async (data)=>{
        ...
        setLoading(true);
        try {
            const destockAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getContractAddress"])("DESTOCK", 31337); // or use chainId if available
            if (tradeType === "buy") {
                await buyShares({
                    abi: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$abi$2f$DeStock$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DESTOCK_ABI"],
                    address: destockAddress,
...
//# sourceMappingURL=apps_web_632046ff._.js.map