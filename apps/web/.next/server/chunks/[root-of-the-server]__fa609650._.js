...
function checkRateLimit(key) {
    const now = Date.now();
    const limit = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$constants$2f$shared$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RATE_LIMITING"].market;
...
async function getMarketDataFromBackend(type, params = {}) {
    try {
        switch(type){
            case 'companies':
...
function generateFallbackData(type, params = {}) {
...
async function GET(request) {
    try {
        ...
        const backendData = await getMarketDataFromBackend(type, {
            symbol,
            timeframe,
            days
        });
        if (backendData) {
            ...
            dataSource = 'fallback';
            responseData = generateFallbackData(type, {
                symbol,
                timeframe,
                days
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa609650._.js.map